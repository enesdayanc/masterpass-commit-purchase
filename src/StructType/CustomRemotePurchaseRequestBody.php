...
/**
 * This class stands for CustomRemotePurchaseRequestBody StructType
 * @subpackage Structs
 */
class CustomRemotePurchaseRequestBody extends BaseCustomPurchaseRequestBody
{
    /**
    ...
    /**
     * Constructor method for CustomRemotePurchaseRequestBody
     * @uses CustomRemotePurchaseRequestBody::setSend_sms_merchant()
     * @uses CustomRemotePurchaseRequestBody::setMsisdn()
     * @uses CustomRemotePurchaseRequestBody::setList_account_name()
     * @uses CustomRemotePurchaseRequestBody::setAdditional_fields()
     ...
     * @param string $send_sms_merchant
     * @return \Enesdayanc\MasterpassCommitPurchase\StructType\CustomRemotePurchaseRequestBody
     */
