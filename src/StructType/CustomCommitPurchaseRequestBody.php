...
/**
 * This class stands for CustomCommitPurchaseRequestBody StructType
 * @subpackage Structs
 */
class CustomCommitPurchaseRequestBody extends BaseCustomPurchaseRequestBody
{
    /**
     * The custom_fields
    ...
    /**
     * Constructor method for CustomCommitPurchaseRequestBody
     * @uses CustomCommitPurchaseRequestBody::setCustom_fields()
     * @uses CustomCommitPurchaseRequestBody::setToken()
     * @uses CustomCommitPurchaseRequestBody::setMsisdn()
     * @uses CustomCommitPurchaseRequestBody::setOrder_details()
     * @uses CustomCommitPurchaseRequestBody::setBill_details()
     * @uses CustomCommitPurchaseRequestBody::setDelivery_details()
     * @uses CustomCommitPurchaseRequestBody::setBuyer_details()
     * @uses CustomCommitPurchaseRequestBody::setAnti_fraud_details()
     * @uses CustomCommitPurchaseRequestBody::setOther_details()
     ...
     * @param \Enesdayanc\MasterpassCommitPurchase\StructType\MasterPassRequestCustomField $custom_fields
     * @return \Enesdayanc\MasterpassCommitPurchase\StructType\CustomCommitPurchaseRequestBody
     */
