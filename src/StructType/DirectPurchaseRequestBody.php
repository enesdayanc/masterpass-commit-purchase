...
/**
 * This class stands for DirectPurchaseRequestBody StructType
 * @subpackage Structs
 */
class DirectPurchaseRequestBody extends BasePurchaseRequestBody
{
    /**
     * The rta_cvc2
    ...
    public $expiry_date;
    /**
     * Constructor method for DirectPurchaseRequestBody
     * @uses DirectPurchaseRequestBody::setRta_cvc2()
     * @uses DirectPurchaseRequestBody::setCard_holder_name()
     * @uses DirectPurchaseRequestBody::setAdditional_fields()
     * @uses DirectPurchaseRequestBody::setRta_pan()
